...
var PIXEL_ENDPOINT     = process.env.OPIX_PIXEL_ENDPOINT || 'https://us-central1-trakmarket-dev.cloudfunctions.net/pixel';

// The core openpixel.min.js file that the snippet will loaded asynchronously into the browser
var JS_ENDPOINT        = process.env.OPIX_JS_ENDPOINT || 'https://trakmarket-dev.web.app/assets/js/openpixel.min.js';
